...
'https://play.google.com/store/apps/details?id=de.thorstensapps.ttf&hl=en_US&gl=US

Partial Class Etapas_PresentacionReto
...
#End Region
    ...
    Private Sub Etapas_PresentacionReto_Load(sender As Object, e As EventArgs) Handles Me.Load
