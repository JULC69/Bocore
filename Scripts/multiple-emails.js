(function ($) {
    $.fn.multiple_emails = function (options) {
        ...
        return this.each(function () {
            ...
            var $orig = $(this);
            var $list = $('<ul id="' + settings.idUL + '" class="multiple_emails-ul" />'); // create html elements - list of email addresses as unordered list
            ...
            var $input = $('<input id="' + settings.idControl + '" type="text" class="multiple_emails-input text-left" list="' + settings.idDataList + '" oninput="onInput(this)" onkeydown="keydownFunction(this)" onfocus="focusFunction(this)" onblur="blurFunction(this)" />').on('keyup', function (e) { // input
            ...
            // Agrega el dataList justo despue`s del control input.
            $container.append("<datalist id='" + settings.idDataList + "'></datalist>");
...
//function onkeydownFunction(obj) {
//   //alert("keydown");
//   var idInput = $("#" + $(obj).attr("id")).attr("id");
//   var valor = $("#" + idInput).val();
//}

// Permite agregar borde sombreado (focused) al DIV (similar al estilo form-control al tomar el enfoque) 
// que anida cada uno de los emails que el usuario agregar. El estilo 'focused' se encuentra
// definido en el <header> de la pa´gina.
function focusFunction(obj) {
    //alert("Focus" + $(obj).attr("id"));
    var idDivPadre = $("#" + $(obj).attr("id")).parent().parent().attr("id");
    $("#" + idDivPadre + " .multiple_emails-container").addClass('focused');
}

function blurFunction(obj) {
    //alert("Blur");
    var idDivPadre = $("#" + $(obj).attr("id")).parent().parent().attr("id");
    $("#" + idDivPadre + " .multiple_emails-container").removeClass('focused');
}
